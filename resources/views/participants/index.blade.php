...
<body>
    ...
    <div class="container">
        <a href="{{ route('participants.create') }}" class="btn-add">+ Tambah Peserta</a>
        <table>
            <thead>
                <tr>
                    <th>No.</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td data-label="Nama">{{ $participant->name }}</td>
                    <td data-label="Alamat">{{ $participant->address }}</td>
                    <td data-label="No. Telepon">{{ $participant->phone }}</td>
                    <td data-label="Aksi" class="action-buttons">
                        <a href="{{ route('participants.show', $participant->id) }}">👁️ Lihat</a>
                        <a href="{{ route('participants.edit', $participant->id) }}">✏️ Edit</a>
